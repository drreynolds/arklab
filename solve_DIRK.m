function [tvals,Y,nsteps,lits,cfails,afails] = solve_DIRK(fcn,Jfcn,tvals,Y0,B,rtol,atol,hmin,hmax,alg)
% usage: [tvals,Y,nsteps,lits,cfails,afails] = solve_DIRK(fcn,Jfcn,tvals,Y0,B,rtol,atol,hmin,hmax,alg)
%
